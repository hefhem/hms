...
export class SeedService implements OnApplicationBootstrap {
  ...
  private async seedServices() {
    ...
    const demoServices = [
      ...
      { tenantId: apexId, code: 'SRV-CONS-GEN', name: 'General Doctor Consultation Fee', category: ServiceCategory.CONSULTATION, department: 'General OPD', price: 50.0, currency: 'USD', taxRate: 0, isActive: true },
      { tenantId: apexId, code: 'SRV-CONS-SPEC', name: 'Specialist Physician Consultation', category: ServiceCategory.CONSULTATION, department: 'Internal Medicine', price: 120.0, currency: 'USD', taxRate: 0, isActive: true },
      { tenantId: stNichId, code: 'SRV-STN-CONS', name: 'St. Nicholas Specialist Consultation Fee', category: ServiceCategory.CONSULTATION, department: 'Specialist Clinic', price: 35000.0, currency: 'NGN', taxRate: 0, isActive: true },

      // Laboratory Services Master Catalog
      {
        tenantId: apexId,
        code: 'LAB-CBC',
        ...
        referenceRange: 'WBC: 4.5-11.0 x10^9/L, Hb: 12.0-17.5 g/dL, PLT: 150-450 x10^9/L',
        price: 45.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
      },
      {
        ...
        referenceRange: '70 - 99 mg/dL (Normal Fasting Glucose)',
        price: 20.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
      },
      {
        ...
        department: 'Biochemistry',
        specimenType: 'Serum',
        referenceRange: 'ALT: 7-56 U/L, AST: 10-40 U/L, Total Bilirubin: 0.1-1.2 mg/dL',
        price: 75.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
      },
      {
        tenantId: apexId,
        code: 'LAB-LIPID',
        name: 'Lipid Profile Panel (Total Chol, HDL, LDL, Trig)',
        category: ServiceCategory.LABORATORY,
        department: 'Biochemistry',
        specimenType: 'Serum',
        referenceRange: 'Total Chol: <200 mg/dL, Triglycerides: <150 mg/dL',
        price: 60.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
      },
      {
        tenantId: apexId,
        code: 'LAB-URINE',
        name: 'Urinalysis & Microscopy Panel',
        category: ServiceCategory.LABORATORY,
        department: 'Microbiology',
        specimenType: 'Mid-Stream Urine',
        referenceRange: 'pH: 5.0-7.0, Protein: Negative, Nitrite: Negative',
        price: 25.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
      },
      {
        tenantId: apexId,
        code: 'LAB-MALARIA',
        name: 'Malaria Parasite Microscopy (MP Film)',
        category: ServiceCategory.LABORATORY,
        department: 'Parasitology',
        specimenType: 'Capillary Whole Blood',
        referenceRange: 'No Parasite Seen (NPS)',
        price: 15.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
      ...
      {
        tenantId: stNichId,
        code: 'SRV-STN-LAB-CBC',
        name: 'St. Nicholas Complete Blood Count',
        category: ServiceCategory.LABORATORY,
        department: 'Hematology',
        specimenType: 'Whole Blood (EDTA)',
        referenceRange: 'WBC: 4.5-11.0 x10^9/L, Hb: 12.0-17.5 g/dL',
        price: 25000.0,
        currency: 'NGN',
        taxRate: 0,
        isActive: true,
      ...
      // Radiology Services Master Catalog
      {
        tenantId: apexId,
        code: 'RAD-XRAY-CHEST',
        ...
        modality: 'X-RAY',
        bodyRegion: 'Chest',
        prepInstructions: 'Remove metallic necklaces, body piercings, and clothing with metal zippers.',
        price: 85.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
      ...
      {
        tenantId: apexId,
        code: 'RAD-USG-ABDOMEN',
        name: 'Abdominopelvic Ultrasound Scan',
        category: ServiceCategory.RADIOLOGY,
        department: 'Ultrasonography',
        modality: 'ULTRASOUND',
        bodyRegion: 'Abdomen & Pelvis',
        prepInstructions: 'Fasting 6-8 hours prior to scan. Drink 1 Liter of water 1 hour prior for full urinary bladder.',
        price: 110.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
      },
      {
        tenantId: apexId,
        code: 'RAD-CT-BRAIN',
        name: 'Brain Computed Tomography (CT Non-Contrast)',
        category: ServiceCategory.RADIOLOGY,
        department: 'CT Imaging',
        modality: 'CT_SCAN',
        bodyRegion: 'Head / Brain',
        prepInstructions: 'No metallic hair clips. Inform technician if pregnant or wearing dental metallic implants.',
        price: 350.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
      },
      {
        tenantId: apexId,
        code: 'RAD-MRI-SPINE',
        name: 'Lumbar Spine MRI Scan',
        category: ServiceCategory.RADIOLOGY,
        department: 'MRI Suite',
        modality: 'MRI',
        bodyRegion: 'Spine',
        prepInstructions: 'Strict safety screening for cardiac pacemakers, metallic implants, or shrapnel.',
        price: 550.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
      },
      {
        tenantId: apexId,
        code: 'RAD-MAMMO',
        name: 'Digital Bilateral Mammography',
        category: ServiceCategory.RADIOLOGY,
        department: 'Women Imaging',
        modality: 'MAMMOGRAPHY',
        bodyRegion: 'Breast',
        prepInstructions: 'Avoid wearing body powder, deodorants, or antiperspirants on day of procedure.',
        price: 140.0,
        currency: 'USD',
        taxRate: 0,
        isActive: true,
    ...
    for (const s of demoServices) {
      let existing = await this.serviceRepository.findOne({ where: { code: s.code } });
      if (!existing) {
